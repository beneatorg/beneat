...
contract Beneat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beneat";
    ...
    address payable public marketingWalletAddress = payable(0x71B59DB88978b3b43ef337b68A3a05ba40357598); // Marketing Address
    address payable public teamWalletAddress = payable(0xB1F04d083B6D1Fe680a475915cee9Df774CacF62); // Team Address
